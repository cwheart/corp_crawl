...
for corp in Corp.objects(d101a=None, d101t=None, d110a=None, d110t=None):
    ...
    print len(Qualification.objects(corp_no=corp['no'], name='建筑工程施工总承包一级'))
    print len(Qualification.objects(corp_no=corp['no'], name='建筑工程施工总承包特级'))
    print len(Qualification.objects(corp_no=corp['no'], name='市政公用工程施工总承包一级'))
    print len(Qualification.objects(corp_no=corp['no'], name='市政公用工程施工总承包特级'))
